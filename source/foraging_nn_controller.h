 ...
 */
 ...
 #ifndef FORAGING_NN_CONTROLLER_H
 #define FORAGING_NN_CONTROLLER_H
  ...
  */
 class CForagingNNController : public CCI_Controller {
 ...
 public:
    ...
    /* Class constructor. */
    CForagingNNController();
    /* Class destructor. */
    virtual ~CForagingNNController() {}
